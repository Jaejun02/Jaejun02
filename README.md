...
Final-year Data Science and Analytics student at the National University of Singapore (second major in Computer Science), graduating December 2026.

Two internships at GIC: kdb+/q data-access APIs and a Databricks/PySpark migration feasibility study in Trading Analytics, and Python pipelines for portfolio climate-transition analysis in Investment Insights. That work is internal, so the code here is from personal and course projects.
...
Python, SQL, PySpark/Databricks, kdb+/q, R · pandas, NumPy, scikit-learn, PyTorch, CVXPY · FastAPI, Git

## Contact

[LinkedIn](https://www.linkedin.com/in/jaejun-shim-02/) · [jaejun.shim@outlook.com](mailto:jaejun.shim@outlook.com)
